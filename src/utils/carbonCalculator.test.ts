...
describe('scenario validation matrix', () => {
  const scenarios: Array<{ name: string; overrides: Partial<CalculatorInputs> }> = [
    ...
    { name: 'vegetarian household', overrides: { diet: 'vegetarian', meatFrequency: 'never', highImpactMeatFrequency: 'never' } },
    { name: 'heavy non vegetarian household', overrides: { diet: 'non-vegetarian', meatFrequency: 'daily', highImpactMeatFrequency: 'daily' } },
