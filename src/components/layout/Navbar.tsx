                ...
                {user && (
                  <>
                    ...
                    <motion.button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-red-400 hover:bg-red-500/10 transition-colors duration-300 text-sm font-medium"
